...
SocialBiz OS: a Facebook-first social-commerce workspace that turns Messenger conversations into structured orders — with AI intent classification, verified product replies, order confirmation, and revenue attribution for Bangladeshi SMEs.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "293829717+kmhapu@users.noreply.github.com"
  git config user.name "kmhapu"
  ```
